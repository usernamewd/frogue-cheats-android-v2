...
import io.github.necrashter.natural_revenge.cheats.MobileCheatMenu;
...
public class GameScreen implements Screen {
    ...
    // Mobile cheat menu
    private MobileCheatMenu cheatMenu;
...
//            stage.addActor(subtitleGroup);
        ...
        // Initialize mobile cheat menu (only on mobile devices)
        if (Main.isMobile()) {
            cheatMenu = new MobileCheatMenu(world.player.cheatManager, world.player);
            cheatMenu.updatePosition();
            stage.addActor(cheatMenu);
        }
    }
